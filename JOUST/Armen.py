...
class MCTS:
    def __init__(self, time):
        ...
        self.model.load_state_dict(
            torch.load("model_pBirshert.pth", map_location=lambda storage, loc: storage))
        self.model.to(self.device)
        self.model.eval()

        self.model2 = VNet()
        self.model2.load_state_dict(
            torch.load("model_vBirshert.pth", map_location=lambda storage, loc: storage))
